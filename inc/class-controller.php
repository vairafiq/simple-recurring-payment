...
if (!class_exists('SRP_Controller')) :
    ...
    class SRP_Controller
    {
        ...
        {
            add_action('admin_enqueue_scripts', array($this, 'srp_add_assets'));
        ...
        public function srp_add_assets($screen)
        {
            //var_dump($screen);
            ...
            wp_register_script('settingsPanel', SRP_ADMIN_ASSETS . 'js/settings.js', array(), SRP_VERSION, true);

            if ('srp_orders_page_srp-settings' === $screen) {
